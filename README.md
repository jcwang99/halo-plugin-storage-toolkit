...
> ⚠️ **注意**：本插件使用了 WebP native 库进行图片格式转换。由于 JVM 的 native 库加载机制限制，**插件更新后需要重启 Halo** 才能正常工作。热更新可能导致 native 库冲突或功能异常。
...
- **图片处理**：Java ImageIO、WebP ImageIO
